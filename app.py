...
user_text = st.text_area("✉️ Enter your SMS message:", height=120)


# ============================================================
# LIME EXPLAINER — Matches Your Pipeline
# ============================================================
...
def predict_proba_for_lime(texts):
    ...
    # If model is SVM → generate fake probability
...
st.write("---")
st.write("Built with ❤️ using your ML project models + Streamlit + LIME.")